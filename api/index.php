    ...
    <nav class="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        <div class="flex items-center space-x-8">
            ...
            <div class="hidden md:flex items-center space-x-8 font-medium">
                <a href="index.php" class="text-black font-bold">Home</a>
        ...
        <div class="flex items-center space-x-4">
            <a href="#" class="border border-black text-black px-6 py-2 rounded-full font-medium hover:bg-black hover:text-white transition text-center">Masuk</a>
            <a href="#" class="bg-coralPink text-white px-6 py-2 rounded-full font-medium hover:opacity-90 transition text-center">Daftar</a>
        </div>
    </nav>
    ...
    <header class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div class="space-y-6">
            ...
            <p class="text-gray-600 text-lg md:text-xl leading-relaxed max-w-lg">
                Pelurusan rambut merupakan salah satu teknik penataan rambut yang bertujuan untuk mengubah tekstur rambut menjadi lebih lurus, rapi, dan mudah diatur.
            </p>
            <div class="flex items-center space-x-4 pt-4">
                <a href="#" class="border border-black text-black px-8 py-3 rounded-full font-semibold text-lg hover:bg-black hover:text-white transition shadow-sm w-36 text-center">Masuk</a>
                <a href="#" class="bg-coralPink text-white px-8 py-3 rounded-full font-semibold text-lg hover:opacity-90 transition shadow-sm w-36 text-center">Daftar</a>
            </div>
        </div>

        <div class="w-full">
            <img src="https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=1000" alt="Proses Pelurusan Rambut" class="w-full h-auto rounded-lg shadow-md object-cover">
        </div>
    </header>
